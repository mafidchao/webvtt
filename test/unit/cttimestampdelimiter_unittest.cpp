 ...
 */
TEST_F(CueTimeTimestampDelimiter,HourMinuteBadDelimiter1)
{
 ...
 *    thousandths of a second seconds-frac as a base ten integer.
 */
TEST_F(CueTimeTimestampDelimiter,MinuteSecondBadDelimiter1)
{
 ...
 *    thousandths of a second seconds-frac as a base ten integer.
 */
TEST_F(CueTimeTimestampDelimiter,SecondSecondFracBadDelimiter1)
{
 ...
 *    thousandths of a second seconds-frac as a base ten integer.
 */
TEST_F(CueTimeTimestampDelimiter,HourMinuteBadDelimiter2)
{
 ...
 *    thousandths of a second seconds-frac as a base ten integer.
 */
TEST_F(CueTimeTimestampDelimiter,MinuteSecondBadDelimiter2)
{
 ...
 *    thousandths of a second seconds-frac as a base ten integer.
 */
TEST_F(CueTimeTimestampDelimiter,SecondSecondFracBadDelimiter2)
{

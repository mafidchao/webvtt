...
WEBVTT_INTERN webvtt_status webvtt_bytearray_new( webvtt_uint32 alloc, webvtt_bytearray *ppstr );
WEBVTT_INTERN void webvtt_bytearray_delete( webvtt_bytearray *pstr );
